...
<f7-app :params="f7params">
  ...
  <f7-views tabs class="safe-areas">
    ...
    <f7-toolbar tabbar labels bottom>
      <f7-link tab-link="#view-home" tab-link-active icon-ios="f7:home_fil" icon-md="material:home"></f7-link>
      <f7-link tab-link="#view-catalog" icon-ios="f7:list_fill" icon-md="material:view_list"></f7-link>
      <f7-link tab-link="#view-settings" icon-ios="f7:settings_fill" icon-md="material:settings"></f7-link>
    </f7-toolbar>
